  ...
  return (
    <div className="px-8 py-10 max-w-5xl mx-auto">
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        <button className="display ml-auto inline-flex items-center gap-2 rounded-full border border-grass/50 px-5 py-2 text-sm font-semibold text-grass transition hover:bg-grass hover:text-white">
