...
Built from the coach's answers (`docs/coach-answers/`, spec in `docs/build-brief-2026-09-10.md`). Persist is now **version 12**. Real Hudl export sample: `docs/coach-answers/hudl-playlist-sample.csv` (85 snaps; PERSONNEL/PLAYER untagged, OFF PLAY 23/85 — sparse is normal).
